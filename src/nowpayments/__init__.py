...
class NOWPayments:
	...
	def __init__(self, key, sandbox=False):
		self.key = key
		self.sandbox = sandbox

	def get_url(self, endpoint):
		if self.sandbox:
			return self.SANDBOX_API_URL.format(endpoint)
		else:
	...
	def get_payment(self, price_amount=None, price_currency="usd", pay_amount=None, pay_currency="btc",
					ipn_callback_url=None, order_id=None, order_description=None, purchase_id=None, payout_address=None,
